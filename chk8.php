<?php
/* ------------------------------------------------------------------
   بررسیِ زمان‌اجرای «روند پیگیری سفارش» (گروه ب) پشت گیت‌های ورود.
   چون هنوز هیچ سفارشی در دیتابیس نیست، یک مشتری و سفارشِ آزمایشی
...
/* برای هر جدول، ستون‌های NOT NULL بدون مقدار پیش‌فرض را خودکار پر می‌کنیم
   تا به شِمای دقیق وابسته نباشیم. */
...
try {
    ...
    /* --- ۲ب) رندر واقعی صفحهٔ ادمین پشت گیت ورود ---
       order-detail.php از require نسبیِ '../includes/...' استفاده می‌کند، پس باید
