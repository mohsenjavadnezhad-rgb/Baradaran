<?php
/* جستجوی زندهٔ نوار بالای سایت — دراپ‌داونِ assets/js/search.js همین‌جا را
   صدا می‌زند. علاوه بر نام/شمارهٔ فنی/قیمت، حالا برندِ خودرو (از جدولِ
   categories، سرشاخه‌اش) و دسته‌بندیِ قطعه (part_categories) هم برمی‌گردد
