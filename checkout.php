...
/* ---------- گاردِ مرحلهٔ «بررسی عکس نمونهٔ قطعه» + «بررسی موجودی» ----------
   اگر مشتری هنوز نگذشته، به صفحهٔ مناسب برمی‌گردد — part-check.php (هنوز
   اقدامی نکرده) یا stock-check.php (اقدام کرده، فقط منتظرِ ادمین است).
   فقط روی GET؛ چون اگر POSTِ ثبتِ نهایی هم ریدایرکت شود، مشتری‌ای که همین
