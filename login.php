...
<div class="container">
  <div class="auth-card auth-card-wide">
    <?php /* وقتی فقط یکی از دو تب فعال است، عنوان صفحه هم دیگر عمومی
            («ورود / ثبت‌نام») نیست — همان یکی را صریح می‌گوید. */ ?>
    <h1 class="auth-title"><?= icon('login') ?><?= $bothTabsOn ? 'ورود / ثبت‌نام' : ($isPartner ? 'ورود همکار' : 'ورود مشتری') ?></h1>
    ...
    <div class="auth-note">
      ...
      <?php else: ?>
      <?= $otpOn
          ? 'پس از وارد کردن شماره موبایل، یک کد تایید از طریق پیامک برای شما ارسال می‌شود. با وارد کردن کد ارسال‌شده، وارد سامانه خواهید شد.'
