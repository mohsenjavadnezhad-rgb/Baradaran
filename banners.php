...
function renderOfferSlider($offers, $seconds) {
    ...
    /* ۲۰۲۶-۰۹-۰۳: .promo-dots همیشه رندر می‌شود، حتی وقتی فقط یک آفر
       ...
       زیر خود کارت‌اند (نه داخلش)، اسلاتی با ≥۲ آفر یک ردیف نقطهٔ اضافه
       داشت که روی موبایل (بدون کشیدگی گرید هم‌ردیف) کل اسلایدر را
       بلندتر از اسلات تک‌آفره می‌کرد. حالا فضایش همیشه رزرو می‌شود؛
       با یک آفر، خود ردیف با is-empty نامرئی می‌ماند نه حذف. */
