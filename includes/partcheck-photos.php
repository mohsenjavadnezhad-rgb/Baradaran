<?php
/* قطعهٔ مشترکِ نمایش عکس‌های ارسالیِ مشتری در صفحهٔ part-check.php
   از سه حالتِ «در انتظار»، «تأیید شد» و «تأیید نشد» require می‌شود.
   ورودی‌ها (از خودِ part-check.php): $imgs، $row، و در صورت وجود $rowProd.
   نامِ فایل‌ها ساختهٔ سرور است (pc<time>_<rand>.<ext>) ولی باز هم با h() از
   آن‌ها محافظت می‌کنیم و مسیر را ثابت می‌سازیم تا هیچ ورودیِ مشتری در آدرس
   دخالت نکند. */
