...
function settingsSections() {
    return [
        ...
        /* ۲۰۲۶-۰۹-۰۳: از داخلِ بخشِ «سال تولید خودرو» بیرون آمد و دسترسیِ
           مجزایِ خودش را گرفت (خواستهٔ کاربر) — قبلاً هر دو کلید همان‌جا
           بودند، اما موضوعاً جداست (مراحلِ ناوبری، نه بازهٔ سال). */
