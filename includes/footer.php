...
$socialIcons = [
    ...
    /* ایتا: مسیر اصلی در فضای ۴۸ کشیده شده؛ viewBox روی کرانهٔ واقعی خود نشان (≈۴ تا ۴۴)
       تنظیم شده تا لبه‌به‌لبه شود (به‌جای scale که فقط قاب خالی را کوچک می‌کرد).
    ...
    /* بله (Bale) — نشان رسمی ble.ir: دایرهٔ دم‌دار + تیک درونی (تیک = حفره با evenodd) */
    ...
    /* گپ (Gap) — حباب گفتگوی دم‌دار با سه نوار درونی (نوارها = حفره با evenodd) */
    ...
    /* روبیکا (Rubika) — نشان رسمی rubika.ir: مربع گرد دم‌دار + سه نقطه (نقطه‌ها = حفره با evenodd) */
...
<footer class="site-footer">
    <div class="footer-container">
        ...
        <div class="footer-col">
            <h4>دسترسی سریع</h4>
            <?php /* آیتم‌های این ستون هم از همان جدول منوهاست (گروه «footer»)
                    — از includes/header.php وارد شده، پس menu.php از قبل
                    require شده. آیتم سیستمی «account» مثل نوار بالا رفتار
                    می‌کند. */ ?>
...
<script src="assets/js/main.js?v=59"></script>
<script src="assets/js/cart.js?v=59"></script>
<script src="assets/js/search.js?v=59"></script>
<script>
/* «انتخاب فایل» سفارشی برای هر input[type=file].form-control که در سمت
   ...
   به کامنت .file-pick در assets/css/style.css. */
(function () {
