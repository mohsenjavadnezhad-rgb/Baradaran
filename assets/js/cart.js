document.addEventListener('DOMContentLoaded', function () {
    ...
    function applyCartState(form, cart) {
        ...
        /* ردیفِ مالیات: نمایش/مخفی + مقدار. وقتی بلوکِ ارسال روی صفحه نیست،
           ردیفِ «مبلغ کل» را هم همین‌جا زنده می‌کنیم چون applyShipState برای
    ...
    /* ==================================================================
       ...
       هزینه»، هزینهٔ روشِ انتخاب‌شده و مبلغ قابل پرداخت باید با آن عوض شوند
       ...
       shippingCartSummary() می‌سازد که رندر اول صفحه را ساخته، پس عددِ روی
    ...
    function pushQty(form, qty) {
        /* هر درخواست یک شمارهٔ ترتیب دارد؛ پاسخِ دیرکردهٔ کلیک‌های سریع
    ...
    document.querySelectorAll('.cart-update-form').forEach(function (form) {
        ...
        /* Enter داخل فیلد → اعمالِ همان عدد، بدون submit شدن فرم */
    ...
    /* ------------------------------------------------------------------
       ...
       انتخاب در نشستِ سرور ذخیره می‌شود (نه در فرمِ صفحهٔ بعد)، تا صفحهٔ
       ثبت سفارش فقط ثبت نهایی باشد و رقمِ ارسال دست‌کاری‌پذیر نباشد.
